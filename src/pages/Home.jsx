        ...
        <div className="relative">
            ...
            <div className="bg-white pt-6">
                ...
                <div
                    ...
                    className="mt-2 h-[60vh] text-white flex items-center justify-start relative"
                >
                    {/* Dark overlay */}
                    <div className="absolute inset-0 bg-black/60 z-0"></div>
                    <div className="w-[70%] mx-auto relative z-10">
                        <h1 className="lg:text-5xl md:text-4xl sm:text-3xl text-xl font-semibold shimmer-text drop-shadow-[2px_4px_6px_rgba(0,0,0,0.3)] whitespace-nowrap">
